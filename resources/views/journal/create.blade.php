            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-red-50">
                ...
                <div class="bg-gradient-to-r from-lam-green to-green-700 p-8 text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-2">Formulir Pengajuan Dokumen Adat</h3>
                        <p class="text-green-100 max-w-xl">
                            Kontribusi Anda sangat berharga. Silakan lengkapi data dokumen adat di bawah ini untuk ditambahkan ke repositori digital Lembaga Adat Melayu Jambi.
                        </p>
                    </div>
                </div>
