            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-red-50">
                ...
                <div class="bg-gradient-to-r from-lam-green to-green-700 p-8 text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-2">Formulir Pengajuan Jurnal</h3>
                        <p class="text-green-100 max-w-xl">
                            Kontribusi Anda sangat berharga. Silakan lengkapi data jurnal di bawah ini untuk ditambahkan ke repositori digital Lembaga Adat Melayu Jambi.
                        </p>
                    </div>
                </div>
                ...
                <!-- Form Section -->
                <div class="p-8">
                    <form method="POST" action="{{ route('journal.store') }}" class="space-y-8">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1 ml-1">*Pisahkan dengan titik koma (;) jika lebih dari satu</p>
                        ...
                        <div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="document_url" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all" type="url" name="document_url" :value="old('document_url')" required placeholder="https://drive.google.com/file/d/..." />
                                </div>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-100 mt-8">
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center px-6 py-3 border border-gray-300 shadow-sm text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:text-lam-green focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lam-green transition-all">
                            ...
                            <button type="submit" class="inline-flex items-center px-8 py-3 border border-transparent shadow-lg text-sm font-bold rounded-xl text-white bg-gradient-to-r from-lam-green to-green-700 hover:from-green-700 hover:to-red-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lam-green transform hover:-translate-y-0.5 transition-all duration-200">
                                <i class="fas fa-paper-plane mr-2"></i> Submit Jurnal
                            </button>
                        </div>
                    </form>
                </div>
