                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full rounded-xl border-gray-300 focus:border-lam-green focus:ring focus:ring-lam-green focus:ring-opacity-50">{{ old('description') }}</textarea>
