            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-red-50">
                ...
                <div class="bg-gradient-to-r from-lam-green to-green-700 p-8 text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-2">Edit Data Dokumen Adat</h3>
                        <p class="text-green-100 max-w-xl">
                            Perbarui informasi dokumen adat di bawah ini. Pastikan data yang dimasukin akurat dan pas.
                        </p>
                    </div>
                </div>
                ...
                <!-- Form Section -->
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.journals.update', $journal) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="title" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all" type="text" name="title" :value="old('title', $journal->title)" required autofocus placeholder="Masukkan judul lengkap dokumen adat" />
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <x-text-input id="authors" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all" type="text" name="authors" :value="old('authors', $journal->authors)" required placeholder="Nama penulis 1; Penulis 2" />
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="category_id" name="category_id" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl shadow-sm transition-all cursor-pointer">
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="visibility" name="visibility" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl shadow-sm transition-all cursor-pointer">
                                                <option value="public" {{ old('visibility', $journal->visibility) == 'public' ? 'selected' : '' }}>Publik</option>
                                                <option value="private" {{ old('visibility', $journal->visibility) == 'private' ? 'selected' : '' }}>Privat</option>
                                            </select>
                                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <textarea id="abstract" name="abstract" rows="6" class="block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl shadow-sm transition-all p-4" required placeholder="Tuliskan ringkasan atau abstrak dokumen adat di siko...">{{ old('abstract', $journal->abstract) }}</textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <x-text-input id="keywords" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all" type="text" name="keywords" :value="old('keywords', $journal->keywords)" required placeholder="Contoh: Sejarah, Budaya, Melayu" />
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <x-text-input id="publication_date" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all cursor-pointer" type="date" name="publication_date" :value="old('publication_date', $journal->published_at ? \Carbon\Carbon::parse($journal->published_at)->format('Y-m-d') : '')" required />
                                        </div>
                        ...
                        <div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="document_url" class="pl-10 block mt-1 w-full border-gray-200 focus:border-lam-green focus:ring-lam-green rounded-xl transition-all" type="url" name="document_url" :value="old('document_url', $journal->document_url)" placeholder="https://drive.google.com/file/d/..." />
                                </div>
                                <p class="text-xs text-gray-500 mt-2">
                                    * Masukkan link akses publik ke file PDF dokumen adat (Google Drive, S3, Dropbox, dll).
                                </p>
